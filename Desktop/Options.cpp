...
//	
//	Close.setTexture(*rec.textures[ResourceManager::Textures::BUTTONCLOSE]);
...
//SettingConfig::SettingConfig(const int volume, const bool isFullScreen, const char keyFeed, const char keySplit)
//	:m_settingVolume(volume), m_fullScreen(isFullScreen), m_key_Feed(keyFeed), m_key_Split(keySplit)
//{
//}
...
//void SettingConfig::setKeyCode(const keyBindType keyType, const int keyCode)
//{
//	switch (keyType)
//	{
//	case keyBindType::FEED:
//	{
//		m_key_Feed = static_cast<char>(keyCode);
//		break;
//	}
//	case keyBindType::SPLIT:
//	{
//		m_key_Split = static_cast<char>(keyCode);
//		break;
//	}
//	default:
//		break;
